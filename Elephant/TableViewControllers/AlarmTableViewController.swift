...
class AlarmTableViewController: UITableViewController, AlarmDatasetDelegate {
    
    private static var cellReuseIdentifier = "AlarmTableViewController.DatasetItemsCellIdentifier"
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: AlarmTableViewController.cellReuseIdentifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell: UITableViewCell = tableView.dequeueReusableCell(withIdentifier: AlarmTableViewController.cellReuseIdentifier, for: indexPath)
        if cell.detailTextLabel == nil {
            cell = UITableViewCell(style: .value1, reuseIdentifier: AlarmTableViewController.cellReuseIdentifier)
        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        navigationController?.pushViewController(EditAlarmViewController(withIndex: indexPath.row), animated: true)
